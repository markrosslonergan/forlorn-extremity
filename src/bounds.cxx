...
//	double tr = UtildeSq*assumedRate(mS);
	...
	double my_flux_folded_prob = probDecay(mS, my_rate, my_fullrate,16);
	double their_flux_folded_prob = probDecay(mS, their_rate, their_fullrate ,16);
...
//This should be the Zprime decay into e e.
	...
	double ret = Gamma_ZP_EE(1.0, mZprime, mS, 1/sqrt(3),  1/sqrt(3),  1/sqrt(3)); 
